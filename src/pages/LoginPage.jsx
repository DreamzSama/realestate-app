    ...
    return (
        <div className="flex md:flex-row w-full h-screen">
            ...
            <div className="md:w-1/2 hidden md:flex flex-col justify-center space-y-10 items-center">
                <h2 className="text-4xl text-center font-light mx-16">
                    Ohne Probleme. Ohne viel Arbeit. Ohne viel Stress. Mit uns
                    verkaufst du deine Immobilie!
                </h2>
                <img src={mainSVG} alt="Main illustration" />
            </div>
        </div>
    );
};
